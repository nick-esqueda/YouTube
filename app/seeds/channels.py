...
def seed_channels():
    ...
    dude_perfect = Channel(
        channelName='Dude Perfect', email='dp@dp.com', password='password', profileImageUrl="https://youtube-bucket-nick-esqueda.s3.amazonaws.com/dude-perfect.jpg", createdAt="2009-03-17T05:44:36Z", about="5 best buds just kickin' it. If you like Sports + Comedy, come join the Dude Perfect team!")
