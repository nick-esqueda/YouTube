...
from models import db, Video, Channel, video_like, video_dislike
...
def get_video(videoId):
    ...
    # NOTE: separate DB queries to avoid iterating through a very large video.likes list.
    is_video_liked_by_current_user = False
    is_video_disliked_by_current_user = False
    ...
    video["isLikedByCurrentUser"] = is_video_liked_by_current_user
    video["isDislikedByCurrentUser"] = is_video_disliked_by_current_user
